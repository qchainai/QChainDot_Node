...
// Local
use qchain_template_runtime::{opaque::Block, AccountId, Balance, Index};
...
pub type Client = FullClient<qchain_template_runtime::RuntimeApi, TemplateRuntimeExecutor>;
...
impl NativeExecutionDispatch for TemplateRuntimeExecutor {
	...
	fn dispatch(method: &str, data: &[u8]) -> Option<Vec<u8>> {
		qchain_template_runtime::api::dispatch(method, data)
	}

	fn native_version() -> NativeVersion {
		qchain_template_runtime::native_version()
	}
}
